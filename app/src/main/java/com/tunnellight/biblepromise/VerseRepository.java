...
final class VerseRepository {
    ...
    private static List<Topic> buildTopics() {
        List<Topic> topics = new ArrayList<>(Arrays.asList(
                ...
                topic("Children",
                        new Verse("Children, obey your parents in the Lord, for this is right.",
                                "Ephesians 6:1"),
                        new Verse("Jesus said, “Allow the little children, and don’t forbid them to come to me; for the Kingdom of Heaven belongs to ones like these.”",
                                "Matthew 19:14"),
                        new Verse("Train up a child in the way he should go, and when he is old he will not depart from it.",
                                "Proverbs 22:6"),
                        new Verse("Be kind to one another, tender hearted, forgiving each other, just as God also in Christ forgave you.",
                                "Ephesians 4:32"),
